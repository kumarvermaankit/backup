...
// import { Text, Button, SkillTag, Icon } from '@indywise/uikit';
...
// import FoundationS from '../../assets/Foundation.svg';
      ...
      const getJson = async () => {
        try {
          const res = await Axios({
            url:
              'https://public-assets-indywise.s3.ap-south-1.amazonaws.com/FoundationArticlesM.json',
            method: 'GET'
          });
