export const feedback = [
  ...
  },
  {
    ...
    'Would you submit new recommended courses for the mentee?': 'Yes',
    'Please input the courses/tasks the mentee needs to complete in comma separated format (CSV)':
      'Secure coding practices, https://owasp.org/www-pdf-archive/OWASP_SCP_Quick_Reference_Guide_v2.pdf, 02/07/2021,green\n\nSecure code practices, https://kirkpatrickprice.com/blog/secure-coding-best-practices/, 02/07/2021,green',
    'How would you rate your mentee, mentoring-wise?': 5,
    "Once submitted, this assessment can't be amended": 'I agree',
    'Is this the first session with this particular mentee?': '',
    'Is this the first session with this particular mentee?__1': 'No',
  ...
  {
    Timestamp: '30/06/2021 07:57:10',
    'Email address': 'k.vivek1311@gmail.com',
    'Mentor Name': 'Vivek Kumar Tiwary',
    'Mentee Name': 'Lavneesh Jaggi',
    "Mentee's Company Name": 'NA',
    'Would you like to submit a new assessment (with forecast) or only a forecast?':
      '',
    'Assessment number': '23/06 - Week 1',
    'Please select the assessment type': 'Node Js + TypeScript',
    'Quality & testing: Writing code': '',
    'Quality & testing: Testing': '',
    'Debugging & observability: Debugging': '',
    'Software design & architecture: Understanding Code': '',
    ...
    'Is the mentee evolving his skills as planned?': 'Yes',
    'Weekly mentoring remarks':
      'As per the assigned task, mentee has tried by him self and stuck at some point. He has asked question related to integration of shiprocket from the express (node) API.',
    'Pain points of the mentee':
      'Did not explore about typescript by self.\nInclined towards what he knows rather than learning/exploring new tech stack.',
    'Would you like to submit a new forecast for the mentee?': '',
    'Technical Skills': 4,
    Delivery: 4,
    'Feedback, Communication, Collaboration': 4,
    ...
    'Would you submit new recommended courses for the mentee?': '',
    'Please input the courses/tasks the mentee needs to complete in comma separated format (CSV)':
      'Node Typescript Cheatsheet,https://github.com/typescript-cheatsheets/node,-,grey',
    'How would you rate your mentee, mentoring-wise?': 4,
    "Once submitted, this assessment can't be amended": 'I agree',
    'Is this the first session with this particular mentee?': '',
    'Is this the first session with this particular mentee?__1': 'Yes',
    ...
    'Software design & architecture: Understanding Code__1': '',
    'Software design & architecture: Software Architecture__2': '',
    'Knowledge about Typescript': 1,
    Security__1: 3,
    'Quality & testing: Writing code in NodeJs': '',
    'Database Usage': 1,
    'Software design & architecture: Software Architecture__3': 1,
    'Quality & Testing: Writing code in NodeJS': 2,
    'Testing (unit, functional) & Debugging': 2,
    'Database Usage__1': '',
    'Listening and CRM Skills__2': '',
    CSS: '',
    'Knowledge of digital tools - Graphics creation, MailChimp, Hootsuite, Google Analytics, Facebook Analytics, Lead Generation, Presentation prep. etc.__1':
  ...
  {
    Timestamp: '01/07/2021 07:35:52',
    'Email address': 'vaidya.dd10@gmail.com',
    'Mentor Name': 'Dnyanesh Vaidya',
    'Mentee Name': 'Satyajit Biswal',
    "Mentee's Company Name": 'Vested Finance',
    'Would you like to submit a new assessment (with forecast) or only a forecast?':
      '',
    'Assessment number': '27/06 - Week 1',
    'Please select the assessment type': 'Business Development',
    'Quality & testing: Writing code': '',
    'Quality & testing: Testing': '',
    'Debugging & observability: Debugging': '',
    'Software design & architecture: Understanding Code': '',
    ...
    'Basic Design Skills: graphics design and videos': '',
    'Listening and CRM Skills__1': '',
    'Incremental value delivery: Work breakdown': 5,
    'Incremental value delivery: Prioritisation, dependencies': 5,
    'Self-organization: Reliability, delivery accountability': 4,
    'Self-organization: Economic thinking': 4,
    'Feedback: Delivering Feedback': 4,
    'Feedback: Seeking and receiving feedback': 4,
    ...
    'Is the mentee evolving his skills as planned?': 'Yes',
    'Weekly mentoring remarks':
      'Satyajit was aware of his strengths and drawbacks. He seems clear in thoughts about his role and responsibilites.',
    'Pain points of the mentee':
      'Satyajit wants to improve his negotiations skills. I have given him some inputs about assertive communication. How to convey soar decisions in an empathetic way so as to carry on healthy relationships with partners and create win win situations.',
    'Would you like to submit a new forecast for the mentee?': '',
    'Technical Skills': 3,
    Delivery: 5,
    'Feedback, Communication, Collaboration': 5,
    ...
    'Strategic Impact': 4,
    'Forecast specific remarks':
      'Needs improvement on technical skills like data analytics, program management etc.',
    'Would you submit new recommended courses for the mentee?': '',
    'Please input the courses/tasks the mentee needs to complete in comma separated format (CSV)':
      'Data analysis, Program Management - 30/9/21',
    'How would you rate your mentee, mentoring-wise?': 5,
    "Once submitted, this assessment can't be amended": 'I agree',
    'Is this the first session with this particular mentee?': '',
    'Is this the first session with this particular mentee?__1': 'Yes',
    'Is this the first session with this particular mentee?__2': 'Yes',
    'Organisation: Time Management': 4,
    'Content Creation: Office Suite (MS Word, Excel, Powerpoint)': '',
    'Administration: Website Management': '',
    'Organization: Documents Management (GDrive, etc)': '',
    'Content Creation: Email Management': '',
    'Administration: Agenda Coordination': 4,
    'Database usage': '',
    'Quality & testing: Writing code in React': '',
    'Knowledge about JavaScript': '',
    'HTML and CSS': '',
  ...
  {
    Timestamp: '03/07/2021 17:41:38',
    'Email address': 'k.vivek1311@gmail.com',
    'Mentor Name': 'Vivek Tiwary',
    'Mentee Name': 'Lavneesh Jaggi',
    "Mentee's Company Name": 'NA',
    'Would you like to submit a new assessment (with forecast) or only a forecast?':
      '',
    'Assessment number': '30/06 - Week 2',
    'Please select the assessment type': 'Node Js + TypeScript',
    'Quality & testing: Writing code': '',
    'Quality & testing: Testing': '',
    'Debugging & observability: Debugging': '',
    ...
    'Listening and CRM Skills__1': '',
    'Incremental value delivery: Work breakdown': 3,
    'Incremental value delivery: Prioritisation, dependencies': 1,
    'Self-organization: Reliability, delivery accountability': 3,
    'Self-organization: Economic thinking': 3,
    'Feedback: Delivering Feedback': 4,
    'Feedback: Seeking and receiving feedback': 4,
    ...
    'Business Acumen & Strategy: Product Thinking': 3,
    'Additional evaluation comments':
      'I have conducted two session with Lavneesh, key area where he needs to improve is , Attention to detail.   He is not able to get what has been asked for rather he rushes on completeing his assignment.',
    'Is the mentee evolving his skills as planned?':
      'Not sure for now, he is rushing for completing the assignment rather grasping the actual concept.',
    'Weekly mentoring remarks':
      'Had two session with Lavneesh, the very first session he asked the infrastructure of project. He asked question about the difference between typescript and JavaScript. I had walked him through how project is organized. Then we had discussion on how will complete his assignment. We have created chunks of task and trying to complete those chunks.\nI have asked him to create a simple controller and expose two end points with get and post.\nIn 2nd session, I was expecting the to have task completion but he could not make it.\nThen I explained him how to think of creating controller. Post that, I have walk through him about the project which i build for him to take reference. After that we discussed about the shiprocket API. I had demoed him on how to use thunder client to hit the end point exposed by shiprocket. At last, I have asked him to create basic controller and have basic authentication mechanism implemented.',
    'Pain points of the mentee':
      'I have conducted two session with Lavneesh, key area where he needs to improve is , Attention to detail.  He is not able to get what has been asked for rather he rushes on completing his assignment.',
    'Would you like to submit a new forecast for the mentee?': 'No',
    'Technical Skills': 4,
    Delivery: 4,
    'Feedback, Communication, Collaboration': 4,
    ...
    'Would you submit new recommended courses for the mentee?': 'Yes',
    'Please input the courses/tasks the mentee needs to complete in comma separated format (CSV)':
      'Zero to Hero — Node.js (Part — 1),https://medium.com/@akashrajput/zero-to-hero-node-js-f14fe35f2e09,-,grey\n\nSequelize ORM,https://sequelize.org/,-,grey',
    'How would you rate your mentee, mentoring-wise?': 4,
    "Once submitted, this assessment can't be amended": 'I agree',
    'Is this the first session with this particular mentee?': '',
    'Is this the first session with this particular mentee?__1': '',
    ...
    'Software design & architecture: Understanding Code__1': '',
    'Software design & architecture: Software Architecture__2': '',
    'Knowledge about Typescript': 2,
    Security__1: 1,
    'Quality & testing: Writing code in NodeJs': '',
    'Database Usage': 1,
    'Software design & architecture: Software Architecture__3': 2,
    'Quality & Testing: Writing code in NodeJS': 2,
    'Testing (unit, functional) & Debugging': 1,
    'Knowledge of sales tools': '',
    'Understanding of Sales CRM and Pipeline management': '',
    'Negotiation skills': '',
    'Analytical thinking and problem solving': '',
    'Knowledge of Prospecting, closing and engagement': '',
    '': '',
    'Quality & testing: Writing code__2': '',
    'Quality & testing: Testing__2': '',
    'Debugging & observability: Debugging__2': '',
    'Software design & architecture: Understanding Code__2': '',
    'Software design & architecture: Software Architecture__4': '',
    Security__2: '',
    'Database Usage__1': '',
    'Listening and CRM Skills__2': '',
    CSS: '',
  ...
  },
  {
    ...
    'Would you like to submit a new assessment (with forecast) or only a forecast?':
      '',
    'Assessment number': 'Week 6',
    'Please select the assessment type': 'Engineering',
    'Quality & testing: Writing code': 5,
    'Quality & testing: Testing': 4,
    'Debugging & observability: Debugging': 5,
    'Software design & architecture: Understanding Code': 4,
    'Software design & architecture: Software Architecture': 5,
    Security: 4,
    'Data Analysis: Ability to analyze data and draw insights': '',
    'Content: Writing, drafting and editing skills': '',
    'Digital and Social Media Marketing: PPC, SEM and SEO campaigns': '',
    ...
    'Incremental value delivery: Work breakdown': 4,
    'Incremental value delivery: Prioritisation, dependencies': 4,
    'Self-organization: Reliability, delivery accountability': 5,
    'Self-organization: Economic thinking': 4,
    'Feedback: Delivering Feedback': 5,
    'Feedback: Seeking and receiving feedback': 5,
    'Communication: Effective communication': 4,
    'Communication: Knowledge Sharing': 4,
    'Collaboration: Teamwork': 4,
    'Collaboration: Relationship building': 4,
    ...
    Mentoring: 4,
    'Business Acumen & Strategy: Business Acumen': 4,
    'Business Acumen & Strategy: Product Thinking': 5,
    'Additional evaluation comments':
      'He has started to follow the recommended practices and this is gonna help in his deliveries being on Time and of high quality',
    'Is the mentee evolving his skills as planned?': 'Yes',
    'Weekly mentoring remarks':
      'We discussed on a high level that has been covered in this program till now.\nAlso, discussed on some soft skills like "Commitment" and what all things to consider before committing to any task or assignment.\n\nOverall this was a fruitful program, and I am sure that Quresh has evolved as a person and knows  a lot about the recommended engineering process now.',
    'Pain points of the mentee':
      'He just need to stick to the plan and restrain himself from over committing and skipping the process for the sake of speed.',
    'Would you like to submit a new forecast for the mentee?': 'No',
    'Technical Skills': 5,
    Delivery: 4,
    'Feedback, Communication, Collaboration': 4,
    ...
    'Knowledge of Prospecting, closing and engagement': '',
    '': '',
    "How would you rate mentee's emotional Intelligence?": '',
    'Does the mentee have the clarity on long-term vision of the company?': '',
    'Is the mentee well aware about Customer Profiling of their product/service?':
      '',
    'Is the mentee aware about the selling proposition of the product?': '',
    'How well does the mentee know their product niche?': '',
    Security__2: '',
    'Quality & testing: Writing code__2': '',
    'Quality & testing: Testing__2': '',
    'Debugging & observability: Debugging__2': '',
  ...
  {
    Timestamp: '12/07/2021 18:04:54',
    'Email address': 'vaidya.dd10@gmail.com',
    'Mentor Name': 'Dnyanesh Dileep Vaidya',
    'Mentee Name': 'Satyajit Biswal',
    "Mentee's Company Name": 'Vested Finance',
    'Would you like to submit a new assessment (with forecast) or only a forecast?':
      '',
    ...
    'Business Acumen & Strategy: Product Thinking': 3,
    'Additional evaluation comments':
      'Good understanding of business deliverables, needs improvement in handling negotiations and data analytics',
    'Is the mentee evolving his skills as planned?': 'Yes',
    'Weekly mentoring remarks':
      'Satyajit was constructively engaged and concerned about his own skill development',
    'Pain points of the mentee':
      'Satyajit needs improvement on negotiation skills and grief management with partners. He is also seeking inputs in data analytics and project management. I have given him some inputs about assertive communication. How to convey soar decisions in an empathetic way so as to carry on healthy relationships with partners and create win win situations.',
    'Would you like to submit a new forecast for the mentee?': '',
    'Technical Skills': 4,
    Delivery: 4,
    'Feedback, Communication, Collaboration': 3,
    ...
    'Quality & Testing: Writing code in NodeJS': '',
    'Testing (unit, functional) & Debugging': '',
    'Knowledge of sales tools': 4,
    'Understanding of Sales CRM and Pipeline management': 4,
    'Negotiation skills': 3,
    'Analytical thinking and problem solving': 3,
    'Knowledge of Prospecting, closing and engagement': 5,
    '': '',
    "How would you rate mentee's emotional Intelligence?": '',
    'Does the mentee have the clarity on long-term vision of the company?': '',
    'Is the mentee well aware about Customer Profiling of their product/service?':
  ...
  {
    Timestamp: '16/07/2021 22:33:14',
    'Email address': 'yuggee33@gmail.com',
    'Mentor Name': 'Yugandhar Penubolu',
    'Mentee Name': 'Richa Jain',
    "Mentee's Company Name": 'Vested Finance',
    'Would you like to submit a new assessment (with forecast) or only a forecast?':
      '',
    'Assessment number': '10/07 - Week 1',
    'Please select the assessment type':
      "Customer Success and Founding Member's Skills",
    'Quality & testing: Writing code': '',
    'Quality & testing: Testing': '',
    'Debugging & observability: Debugging': '',
    'Software design & architecture: Understanding Code': '',
    ...
    'Additional evaluation comments': '',
    'Is the mentee evolving his skills as planned?':
      'Since its 1st session, will have to wait and see the evolution and improvement',
    'Weekly mentoring remarks':
      'Mentee posed 3 problem statements and was keen in understanding and manage well',
    'Pain points of the mentee':
      'The Mentee seems to struggle a bit with 2 -3 team members who are indifferent to individual and team performance. The pain area is how to improve team performance by managing these individuals better. Mentee has improve on when/how to coach, counsel and manage expectations.',
    'Would you like to submit a new forecast for the mentee?': '',
    'Technical Skills': 4,
    Delivery: 4,
    'Feedback, Communication, Collaboration': 4,
    ...
    'Strategic Impact': 4,
    'Forecast specific remarks':
      'Mentee will improve on leadership skills and networking',
    'Would you submit new recommended courses for the mentee?': '',
    'Please input the courses/tasks the mentee needs to complete in comma separated format (CSV)':
      'Read the Book: Act like a leader Think like a leader by Author Herminia Ibarra, https://www.goodreads.com/book/show/21413975-act-like-a-leader-think-like-a-leader, 30/07/2021,grey',
    'How would you rate your mentee, mentoring-wise?': 5,
    "Once submitted, this assessment can't be amended": 'I agree',
    'Is this the first session with this particular mentee?': '',
    'Is this the first session with this particular mentee?__1': 'Yes',
    ...
    'Knowledge of Prospecting, closing and engagement': '',
    '': '',
    "How would you rate mentee's emotional Intelligence?": 3,
    'Does the mentee have the clarity on long-term vision of the company?': 4,
    'Is the mentee well aware about Customer Profiling of their product/service?': 4,
    'Is the mentee aware about the selling proposition of the product?': 4,
    'How well does the mentee know their product niche?': 4,
    Security__2: '',
    'Quality & testing: Writing code__2': '',
    'Quality & testing: Testing__2': '',
    'Debugging & observability: Debugging__2': '',
  ...
  },
  {
    ...
    'Would you like to submit a new assessment (with forecast) or only a forecast?':
      '',
    'Assessment number': '05/07-WEEK 3',
    'Please select the assessment type': 'Node Js + TypeScript',
    'Quality & testing: Writing code': '',
    'Quality & testing: Testing': '',
    'Debugging & observability: Debugging': '',
    ...
    'Is the mentee evolving his skills as planned?': 'Yes',
    'Weekly mentoring remarks':
      'As on date, I had three session with Lavneesh. In last session, we discussed on the issues he was facing while communicating to API developed by him. Explained him, how to debug the code, and points which were missing for successful compilation of code. Post that, I have demonstrated him how to create the end point for API and asked him to proceed with his own implementation by taking reference from my code.\nAlso, have given him task to share the db diagram which he has to create and use in subsequent tasks.',
    'Pain points of the mentee':
      'a. He is more focused on completing the assignment rather grasping the concept.\nb. He is not giving his 100% to solve the problem faced while developing the code. Even after i have shared the working code with him, he is not able to complete the assignment given to him.',
    'Would you like to submit a new forecast for the mentee?': 'No',
    'Technical Skills': 4,
    Delivery: 4,
    'Feedback, Communication, Collaboration': 4,
    ...
    'Would you submit new recommended courses for the mentee?': 'Yes',
    'Please input the courses/tasks the mentee needs to complete in comma separated format (CSV)':
      'Building a Node.js/TypeScript REST API Part 1: Express.js, https://www.toptal.com/express-js/nodejs-typescript-rest-api-pt-1, -,grey\n\nUsing Sequelize ORM with Node.js and Express, https://stackabuse.com/using-sequelize-orm-with-nodejs-and-express, - ,grey',
    'How would you rate your mentee, mentoring-wise?': 4,
    "Once submitted, this assessment can't be amended": 'I agree',
    'Is this the first session with this particular mentee?': '',
    'Is this the first session with this particular mentee?__1': '',
    ...
    'Database Usage': 2,
    'Software design & architecture: Software Architecture__3': 2,
    'Quality & Testing: Writing code in NodeJS': 1,
    'Testing (unit, functional) & Debugging': 1,
    'Knowledge of sales tools': '',
    'Understanding of Sales CRM and Pipeline management': '',
    'Negotiation skills': '',
