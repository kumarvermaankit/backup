...
const [main,setmain]=useState("My Pie Chart")
const [findex,setfindex]=useState(3)
const [sindex,setsindex]=useState(0)
const [tindex,settindex]=useState(1)
const [frindex,setfrindex]=useState(2)

const [arr,setarr]=useState(["Add Expense","Individual Family Expense","Total Family Expense"])
    ...
    return(
        <div>
            {arr.map((each)=>{
                ...
                return(
              <div>      
              {/* {  each==="Add Expense"?t=findex:each==="My Pie Chart"?t=sindex:each==="Individual Family Expense"?t=tindex:each==="Total Family Expense"?t=frindex:null} */}
...
return(
    ...
    {main==="My Pie Chart"?<div className="maincard a">
    {Pie()}
    </div>:null}
  ...
  {main==="Total Family Expense"?<div className="maincard a">
    ...
    {main!=="My Pie Chart"?<SmallCard main={main} Change={(event)=>Change(event,"My Pie Chart",sindex)} val="My Pie Chart"/>:null}
