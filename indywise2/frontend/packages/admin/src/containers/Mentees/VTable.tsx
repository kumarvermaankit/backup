...
export default function VTable() {
  const { menteeList } = React.useContext(UpdatedMenteeContext);
  menteeList.sort(function (a: any, b: any) {
    var nameA = a.email.trim().toUpperCase();
    var nameB = b.email.trim().toUpperCase();
    if (nameA < nameB) {
      return -1;
    }
    if (nameA > nameB) {
              ...
              <TableRow key={data.ID}>
                <TableCell align="center" component="th" scope="row">
                  <Link
                    ...
                    to={`/updated/mentee-list/${data.ID}`}
                  >
                    {index}
                  </Link>
                </TableCell>
