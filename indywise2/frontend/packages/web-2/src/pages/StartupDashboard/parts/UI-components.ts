...
export const DropDown = styled.div`
  ...
  @media (max-width: 730px) and (max-width: 1920px) and (min-width: 1650px){
    width: 16% !important;
  }
  @media (max-width: 730px) and (max-width: 1650px) and (min-width: 1480px){
    width: 20% !important;
  }
  @media (max-width: 585px) and (max-width: 1300px) and (min-width: 1110px) {
    width: 25% !important;
  }
  @media (max-width: 490px) and (max-width: 1040px) and (min-width: 1001px) {
    width: 30% !important;
  } */
`;
