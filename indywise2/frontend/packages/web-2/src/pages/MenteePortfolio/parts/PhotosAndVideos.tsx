...
const PhotosAndVideos: React.FC<{
  ...
  const handlePhotoSubmission = async (e: any) => {
    ...
    // alert('Upload photo(s) by clicking the submit button!');
    handlePhotoRequest();
  };
  ...
  const handleVideoSubmission = async (e: any) => {
    ...
    const res = await Axios.post(
      `${baseURL}/portfolios/portfolio/video/presigned-url/${currentUser.ID}?type=mentee`,
      {
    ...
    // alert('Upload video by clicking the submit button!');
    handleVideoRequest();
  };
  ...
  const [videoWidth, setVideoWidth] = React.useState('46%');
  ...
  return (
    <Container>
      ...
      <LineFlex style={{ marginTop: '60px' }}>
        <HeadText style={{ marginBottom: '24px' }}>Photos and Videos</HeadText>
        <IconContainer>
          <Icon
            icon="editPen"
            size="24px"
          ...
          <BgImage bgImage={VideoBg} type="video">
            <div>
              ...
              <Text type="subtitle" color="#4B4B4B">
                Add a 30-90 seconds video describing yourself according to the
                instructions
              </Text>
            </div>
            <span>
              ...
              {/* <Button onClick={handleVideoRequest} color="primary">
                Submit
              </Button> */}
            </span>
          </BgImage>
        ...
        {photos && Object.values(photos).length > 0 ? (
          ...
          <BgImage bgImage={ImageBg} type="photo">
            ...
            <span>
              ...
              {/* {signedResponses.length !== 0 && (
              )} */}
              {/* <Button onClick={handlePhotoRequest} color="primary">
                Submit
              </Button> */}
            </span>
          </BgImage>
