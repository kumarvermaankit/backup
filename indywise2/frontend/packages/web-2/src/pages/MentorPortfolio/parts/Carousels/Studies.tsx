...
const Studies: React.FC<any> = ({ submitStd, currStd }) => {
  ...
  const handleStudyUpload = async (e: any) => {
    ...
    const res = await Axios.post(
      `https://dev-api.indywise.com/portfolios/portfolio/study/presigned-url/${ID}`,
      presignStudyPayload
    );
  ...
  const handleCertificationUpload = async (e: any) => {
    ...
    const res = await Axios.post(
      `https://dev-api.indywise.com/portfolios/portfolio/certification/presigned-url/user-8d839201-9c71-457e-a31d-63046fe9469e`,
