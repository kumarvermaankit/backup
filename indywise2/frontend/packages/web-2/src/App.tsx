...
import PaymentCheckoutPage from './pages/WiseUpBusiness/parts/PaymentCheckoutPage';
import './index.css';
...
const PublicRoutes = (
  <>
    <Switch>
      ...
      <Route path="/HomePage" exact component={NewhomePage} />
      ...
      <Route path="/payment" component={PaymentCheckoutPage} />
      <Route
        exact
